...
export default function TermsAndConditions({ setView }) {
  ...
  const email = companyInfo?.email || companyInfo?.contactEmail || branding.email || branding.contactEmail;
        ...
        <div className="space-y-12 text-zinc-700 dark:text-zinc-300 font-jakarta leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p>
                    All bookings must be made at least {branding.minAdvanceBookingDays || 2} days in advance. We reserve the right to refuse bookings that do not meet our operational requirements.
                  </p>
                </div>
                <div>
          ...
          <Reveal delay={500}>
            <section>
              ...
              <p>
                The Client is responsible for providing adequate venue space, utilities, and parking for our catering team. {companyName} is not responsible for providing or arranging decorations, entertainment, or non-food items unless specifically contracted.
              </p>
            </section>
          </Reveal>
          ...
          <Reveal delay={600}>
            <section>
              ...
              <p className="mb-3">
                {companyName} will not be held liable for:
              </p>
          ...
          <Reveal delay={800}>
            <section>
              ...
              <p>
                {companyName} reserves the right to photograph or video the event for portfolio and marketing purposes unless otherwise requested in writing. Client consent is assumed unless explicitly stated otherwise.
              </p>
            </section>
          </Reveal>
          ...
          <Reveal delay={1100}>
            <section>
              ...
              <p>
                All content on the {companyName} website, including text, images, recipes, and designs, is protected by copyright. Unauthorized reproduction or use is prohibited without written permission.
              </p>
            </section>
          </Reveal>
