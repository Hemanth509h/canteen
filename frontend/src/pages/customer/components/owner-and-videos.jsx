          ...
          <Link href="/about-us">
            <Reveal delay={150} className="hover:opacity-80 transition-opacity cursor-pointer">
              ...
              <div className="mt-7 flex flex-wrap gap-3 items-center">
                <span className="inline-flex items-center rounded-full bg-amber-500 px-6 py-3 text-sm font-semibold text-white shadow-sm shadow-amber-500/20">Read Founder Story</span>
