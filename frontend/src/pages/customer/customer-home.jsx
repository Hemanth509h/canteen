...
export default function CustomerHome() {
  ...
  const { dataoodItems, isLoadingoadingFood, erroroodError } = useQuery<FoodItem[]>({
  ...
  const { dataeviews, isLoadingoadingReviews, erroreviewsError } = useQuery<CustomerReview[]>({
