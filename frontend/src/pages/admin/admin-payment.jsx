        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="animate-in fade-in duration-300 lg:col-span-2 space-y-6">
              ...
              <Card className={finalPaid ? "border-green-300 dark:border-green-800" : advancePaid ? "border-blue-300 dark:border-blue-800" : "border-muted"}>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    {isEditing ? (
                      <Select value={editFinalStatus || "pending"} onValueChange={(val) => setEditFinalStatus(val)} disabled={!advancePaid}>
                  ...
                  <div className="border-t pt-3 space-y-3">
                    ...
                    <div className="space-y-2">
                      {!booking.finalPaymentScreenshot ? (
                        ...
                        <div className="bg-amber-50 dark:bg-amber-950/30 p-3 rounded-lg border border-amber-200 dark:border-amber-800">
                          <p className="text-sm font-semibold text-amber-700 dark:text-amber-200 mb-2">Final Payment Pending Approval</p>
                        </div>
                      ) : finalPaid ? (
                        <div className="bg-green-50 dark:bg-green-950/30 p-3 rounded-lg border border-green-200 dark:border-green-800">
                          <p className="text-sm font-semibold text-green-700 dark:text-green-200">Final Payment Approved</p>
                        </div>
                      ) : null}
                      {!isEditing && (
                        <div className="flex gap-2">
            ...
            {isEditing && (
              <div className="flex gap-3 animate-in fade-in slide-in-from-bottom-4">
                <Button className="flex-1 gap-2" onClick={() => updatePaymentMutation.mutate()} disabled={updatePaymentMutation.isPending} data-testid="button-save-payment-admin">
                  <Save className="w-4 h-4" />
                  {updatePaymentMutation.isPending ? "Saving..." : "Save Changes"}
                </Button>
                <Button variant="outline" className="flex-1 gap-2" onClick={handleCancelEdit} data-testid="button-cancel-payment-admin">
                  <X className="w-4 h-4" />
                  Cancel
                </Button>
              </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4 pt-4">
                <Button variant="outline" className="w-full gap-2" data-testid="button-calculator-admin">
                  <Calculator className="w-4 h-4" />
                  Payment Calculator
                </Button>
                <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-xl border border-blue-100 dark:border-blue-900/50">
                  <h4 className="text-sm font-semibold text-blue-700 dark:text-blue-300 mb-1">Internal Note</h4>
                  <p className="text-xs text-blue-600/80 dark:text-blue-400/80 leading-relaxed">
                    Always verify screenshots with actual bank statements before approving large payments.
                  </p>
                </div>
              </CardContent>
            </Card>
