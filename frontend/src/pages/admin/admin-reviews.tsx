...
export default function ReviewsManager() {
  ...
  const { data: reviews, isLoading, isFetching, refetch } = useQuery<CustomerReview[]>({
  ...
  const form = useForm<UpdateCustomerReview>({
  ...
  const updateMutation = useMutation({
    mutationFn: async ({ id, data }: { id: string; data: UpdateCustomerReview }) => {
  ...
  const onSubmit = (data: UpdateCustomerReview) => {
    if (editingReview) {
