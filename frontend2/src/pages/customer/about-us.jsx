...
export default function AboutUs({ setView }) {
  ...
  const eventsPerYear = branding?.eventsPerYear || 50;
  const ownerImageUrl = branding?.ownerImageUrl;

  const stats = [
    { icon: Award, label: "Years of Experience", value: `${yearsExperience}+` },
        ...
        <div className="max-w-6xl mx-auto text-center">
          <Reveal>
            ...
            <p className="text-lg text-zinc-600 dark:text-zinc-300 max-w-2xl mx-auto">
              {branding.companyName} was founded with a single mission: to transform every event into an unforgettable culinary experience.
            </p>
          </Reveal>
        </div>
      </section>
